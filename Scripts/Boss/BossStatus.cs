...
public class BossStatus : MonoBehaviour
{
    ...
    #region Hp関連
    [Header("Hp関連")]
    [SerializeField, Tooltip("ボスの初期HP")] protected float _bossFirst_HP = default;
    private float _boss_HP = default; //ボスの現在HP
    ...
    private bool _isHpHalf;//Hp半分
    /// <summary>
    /// ボスのHpが半分
    /// </summary>
    public bool IsHpHalf() { return _isHpHalf; }
    private bool _isUlt;//ウルト使用中
    /// <summary>
    /// ウルト開始
    /// </summary>
    ...
    private bool _isStart = false;//ボス戦開始
